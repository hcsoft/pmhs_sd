...
//
////    $('.toolbar').append('<button rel="side-a" class="printPrev gBtn showWhenModify">打印正面</button>').append('<button rel="side-b" class="printPrev gBtn showWhenModify">打印背面</button>');
//    $('.toolbar').append('<button rel="side-a" class="printPrev btnprint showWhenModify"><img title="打印正面" src="../image/print_positive_32_32.png"/>打印正面</button>').append('<button rel="side-b" class="printPrev btnprint showWhenModify"><img title="打印背面" src="../image/print_reversal_32_32.png"/>打印背面</button>');
//	function fillCards(){
//        var loaded = {};
//        if (medObj){
